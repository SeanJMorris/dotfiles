# Note from Sean: 
# some of the text below comes from https://gist.github.com/marioBonales/1637696
# Sean has made some small edits to what's here from Mario Bonales
# Sean has also added more below - see the 'ADDED BY SEAN' section. 

# ~/.bashrc: executed by bash(1) for non-login shells.
# see /usr/share/doc/bash/examples/startup-files (in the package bash-doc)
# for examples

# If not running interactively, don't do anything (the interactive - read, normal) 
# shell waits for your input. A non-interactive shell is a script - an example
# would be a background cron job.
case $- in
    *i*) ;;
      *) return;;
esac
...
# ADDED BY SEAN ADDED BY SEAN ADDED BY SEAN ADDED BY SEAN ADDED BY SEAN
#
